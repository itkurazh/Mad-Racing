...
public class LocalVehicle
{
    ...
    private VehicleController _controller => _vehicle.Data.Controller;
    
    private VehicleConfig _config => Configs.Get<VehicleConfig>();
    
    public LocalVehicle(Vehicle vehicle)
    {
        _vehicle = vehicle;
    }
    ...
    public void Rotate(float axis)
    {
        ...
        var force = _config.AngularAcceleration.Evaluate(_data.VelocityClamp) * _config.AngularSpeed * Mathf.Clamp(_data.CurrentVelocity, -1, 1);
